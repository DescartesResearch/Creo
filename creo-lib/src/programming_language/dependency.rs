...
impl ProgrammingLanguage {
    pub fn get_local_handler_dependencies(
        ...
        match self {
            ...
            Node(_) => generator::node::get_local_handler_dependencies(lib_dir)
        }
    }
    ...
    pub fn dependency_file_name(&self) -> &'static str {
        match self {
            ...
            Node(_) => generator::node::DEPENDENCY_FILE_NAME,
        }
    }
    ...
    pub fn as_dependency_file_template_path(&self) -> &'static str {
        match self {
            ...
            Node(_) => generator::node::DEPENDENCY_FILE_TEMPLATE_PATH,
        }
    }
}
