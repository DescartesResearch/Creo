...
pub const DOCKERFILE_TEMPLATE_PATH: &str = "node/Dockerfile.mgt";
pub const DEPENDENCY_FILE_NAME: &str = "package.json";
pub const DEPENDENCY_FILE_TEMPLATE_PATH: &str = "node/package.mgt";
